...
export const SAMPLE_PROJECT_KITCHEN: ProjectData = {
  ...
  cabinets: [
    ...
    { id: 'B05', name: 'سفلي مسطح طهي وبوتجاز', category: 'base', type: 'base-drawers-2', projectType: 'kitchen', width: 900, height: 720, depth: 560, x: 4200, y: 900, z: 100, rotation: 90, wallId: 'wall-b', shelfCount: 0, doorCount: 0, drawerCount: 2, doorHinge: 'none' },
    { id: 'W01', name: 'علوي بابين مدمج بالشفاط', category: 'wall', type: 'wall-double-door', projectType: 'kitchen', width: 900, height: 720, depth: 350, x: 4200, y: 900, z: 1450, rotation: 90, wallId: 'wall-b', shelfCount: 2, doorCount: 2, drawerCount: 0, doorHinge: 'double' },
  ],
  appliances: [
    { id: 'A01', name: 'حوض ساقط بالرخام', type: 'sink-single', width: 600, height: 200, depth: 450, x: 1900, y: 100, z: 850, rotation: 0, wallId: 'wall-a' },
    { id: 'A02', name: 'مسطح طهي بلت إن', type: 'cooktop-induction', width: 800, height: 50, depth: 520, x: 4200, y: 950, z: 850, rotation: 90, wallId: 'wall-b' },
